-- primary keys
ALTER TABLE patient ADD CONSTRAINT xpk_patient PRIMARY KEY (person_id);
ALTER TABLE conditions ADD CONSTRAINT xpk_conditions PRIMARY KEY (condition_occurrence_id);
